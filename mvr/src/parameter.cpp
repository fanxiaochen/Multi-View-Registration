...
//////////////////////////////////////////////////////////////////////////////////////////////
void
Parameter::setModelData(QWidget *editor, QAbstractItemModel *model, const QModelIndex &index)
{
...
//////////////////////////////////////////////////////////////////////////////////////////////
void
IntParameter::setEditorData(QWidget *editor)
{
...
//////////////////////////////////////////////////////////////////////////////////////////////
void
IntParameter::getEditorData(QWidget *editor)
{
  QSpinBox *spinBox = static_cast<QSpinBox*>(editor);
...
//////////////////////////////////////////////////////////////////////////////////////////////
void
BoolParameter::setEditorData(QWidget *editor)
{
...
//////////////////////////////////////////////////////////////////////////////////////////////
void
  BoolParameter::getEditorData(QWidget *editor)
{
  QCheckBox *checkBox = static_cast<QCheckBox*>(editor);
...
//////////////////////////////////////////////////////////////////////////////////////////////
void
DoubleParameter::setEditorData(QWidget *editor)
{
...
//////////////////////////////////////////////////////////////////////////////////////////////
void
DoubleParameter::getEditorData(QWidget *editor)
{
  QDoubleSpinBox *spinBox = static_cast<QDoubleSpinBox*>(editor);
...
//////////////////////////////////////////////////////////////////////////////////////////////
void
ColorParameter::setEditorData(QWidget *editor)
{
...
//////////////////////////////////////////////////////////////////////////////////////////////
void
ColorParameter::getEditorData(QWidget *editor)
{
  QColorDialog *color_dialog = static_cast<QColorDialog*>(editor);
